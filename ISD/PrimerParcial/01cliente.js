/*
Vamos a programar un cliente mediante el cual vamos a probar la arquitectura cliente-servidor por medio de una petición mediante el protocolo HTTP,
utilizando el método GET a la ruta: /api/talleres

Quw tenemos que conectarnos al servicio de la BD

El problema es como apuntar al backend

*/

const API_URL = "https://proyectobackcecyt9.onrender.com"; //Cambia esto segùn la URL de tu backend

async function main() {
    
    console.log("Cliente Peticiòn Get -> a ${API_URL}/api/talleres");
